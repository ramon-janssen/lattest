...
genExpr :: Arbitrary t => Int -> Gen (ExprView t)
genExpr 0 = oneof [
...
genExpr n | n > 0 = oneof [
    ...
    CM.liftM3 EqualInt subexpr2 subexpr2 subexpr2,
    CM.liftM3 EqualBool subexpr2 subexpr2 subexpr2,
    CM.liftM3 EqualString subexpr2 subexpr2 subexpr2,
    CM.liftM2 Divide subexpr2 subexpr2,
    CM.liftM2 Modulo subexpr2 subexpr2,
    CM.liftM Sum (GE.fromList <$> listOf subexpr2Int),
    CM.liftM Product (listOf subexpr2),
    CM.liftM Length subexpr,
    CM.liftM GezInt subexpr,
    CM.liftM Not subexpr,
    CM.liftM And (listOf subexpr2),
    ...
    subexpr2Int :: Gen (ExprView Integer)
    subexpr2Int = subexpr2

prop_symbolicEval :: Expr Integer -> Property
...
instance ConcreteEval Integer where
    ...
    concreteEval' (Length e) = concreteUnaryOp' length e
    concreteEval' (Sum e1 e2) = concreteBinOp (+) e1 e2
    concreteEval' (Product e1 e2) = concreteBinOp (*) e1 e2
...
concreteUnaryOp :: (ConcreteEval t1) => (t1 -> t2) -> ExprView t1 -> ExprView t2
